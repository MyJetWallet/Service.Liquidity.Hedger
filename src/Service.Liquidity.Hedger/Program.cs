...
using Service.Liquidity.Hedger.Settings;
...
namespace Service.Liquidity.Hedger
{
    public class Program
    {
        ...
        {
            Console.Title = "MyJetWallet Service.Liquidity.Hedger";

            Settings = SettingsReader.GetSettings<SettingsModel>(SettingsFileName);

            using var loggerFactory =
                LogConfigurator.ConfigureElk("MyJetWallet", Settings.SeqServiceUrl, Settings.ElkLogs);
